...
// limitations under the License.
  ...
  protocol AuthWebViewControllerDelegate: AnyObject {
    /// Notifies the delegate that the web ui controller is being cancelled by the user.
    /// - Parameter webViewController: The web ui controller in question.
    ...
    /// Notifies the delegate that the web ui controller failed to load a page.
    /// - Parameter webViewController: The web ui controller in question.
