...
#ifndef FIRESTORE_CORE_SRC_IMMUTABLE_LLRB_NODE_ITERATOR_H_
#define FIRESTORE_CORE_SRC_IMMUTABLE_LLRB_NODE_ITERATOR_H_
...
#endif  // FIRESTORE_CORE_SRC_IMMUTABLE_LLRB_NODE_ITERATOR_H_
