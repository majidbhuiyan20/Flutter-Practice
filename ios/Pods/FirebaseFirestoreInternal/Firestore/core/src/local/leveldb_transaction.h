...
#ifndef FIRESTORE_CORE_SRC_LOCAL_LEVELDB_TRANSACTION_H_
#define FIRESTORE_CORE_SRC_LOCAL_LEVELDB_TRANSACTION_H_
...
#endif  // FIRESTORE_CORE_SRC_LOCAL_LEVELDB_TRANSACTION_H_
