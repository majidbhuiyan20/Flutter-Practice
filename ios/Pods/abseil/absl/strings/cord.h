 ...
 public:
  ...
  class ChunkIterator {
   ...
   private:
    ...
    // A ui into bytes of the current `CordRep`. It may only be a ui to a
  ...
  // Cord::ChunkRemaining()
  //
  // Returns the longest contiguous ui starting at the iterator's position.
  //
  ...
  // Cord::Flatten()
  //
  // Flattens the cord into a single array and returns a ui of the data.
  //
