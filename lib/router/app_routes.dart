...
import 'package:practice/ostad_flutter/extend_the_greeting_app/gretting_app_screen.dart';
...
final GoRouter router = GoRouter(
  routes: [
    ...
    GoRoute(path: '/greetingApp', builder: (context, state) => const GrettingAppScreen()),
